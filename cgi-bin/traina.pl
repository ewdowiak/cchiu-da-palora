...
my $amhash = retrieve('../cgi-lib/traina-list');
...
get '/' => sub ($c) {
    ...
    my $output = mk_htmlpage( $par_palora , $par_coll );
...
sub mk_htmlpage {
	...
	$othtml .= mk_amtophtml("../config/eryk2-topnav.html" ,"");
	...
	$othtml .= mk_amtophtml("../config/eryk2-topnav.html" , $title_insert );
	...
	$othtml .= mk_amtophtml("../config/eryk2-topnav.html" , $palora );
    ...
    my $text_url   = 'https://www.napizia.com/cgi-bin/traina.pl';
    my $text_title;
    ...
    $othtml .= mk_foothtml("../config/eryk2-navbar.html");
