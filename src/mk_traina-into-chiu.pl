...
##  input files 
my $vnotesfile = '../lib/stor/vocab-notes';
my $traina_hlfile = "../lib/stor/traina_hdword-to-line";
my $dieli_sc_dict = '../lib/stor/dieli-sc-dict'; 
my $dieli_en_dict = '../lib/stor/dieli-en-dict'; 
my $dieli_it_dict = '../lib/stor/dieli-it-dict'; 

##  output files
my $vnotesplusfile = '../lib/stor/vocab-notes-plus';
my $dieliplus_sc_dict = '../lib/stor/dieliplus-sc-dict'; 
my $dieliplus_en_dict = '../lib/stor/dieliplus-en-dict'; 
my $dieliplus_it_dict = '../lib/stor/dieliplus-it-dict'; 
