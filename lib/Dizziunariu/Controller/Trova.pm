...
$example .= '<li><a href="/trova/?palori=mari"><span class="code">mari</span></a></li>'."\n";
$example .= '<li><a href="/trova/?palori=acqua%20fimmini%20e%20focu"><span class="code">acqua '."\n";
...
sub welcome ($self) {
    ...
    my $par_palori = $self->param('palori');
    my $par_autori = $self->param('autori');
    my $par_titulu = $self->param('titulu');
