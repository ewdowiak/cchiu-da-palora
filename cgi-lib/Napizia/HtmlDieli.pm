...
require Exporter;
our @ISA = qw(Exporter);
our @EXPORT = ("mk_search","translate","mk_ddtophtml","mk_newform",
    "thank_dieli","mk_ricota","mk_foothtml");
...
sub mk_ddtophtml {
    ...
    if ( $param_search eq "" ) {
	my $urlref = 'https://www.napizia.com/cgi-bin/sicilian.pl';
    ...
    my $logopic = 'https://www.napizia.com/pics/dizziunariu-dieli.jpg';
