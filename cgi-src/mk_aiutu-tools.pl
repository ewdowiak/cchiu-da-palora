...
sub make_alfa_welcome {
    ...
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Stu situ web nun nfurna biscotti.  Si voi manciari biscotti, ti pregu di jiri a lu'."\n";
    $othtml .= ' panificiu cchiù vicinu.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Stu situ web reggistra lu to ndrizzu IP e l'."'".'&nbsp;agenti utenti di lu to browser,'."\n";
    $othtml .= ' però in generali nun vogghiu ricògghiri la to informazioni pirsunali.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Chiddu ca vogghiu ricògghiri è informazioni di palori siciliani.  Speru ca mi aiuti.</p>'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 0.95em;">Pi sapiri chi furnisci informazioni di palori siciliani, ti dumannu di lu to nomu.'."\n";
    $othtml .= ' Ma nun ti custrinciu a rivelari sta informazioni o qualsiasi àutra informazioni.  Si mi dici lu to nomu,'."\n";
    $othtml .= ' allura presumu di aviri lu cunsensu esplicitu necessariu a li sensi di lu regulamentu UE 2016/679 pi'."\n";
...
sub make_welcome_msg {
    ...
    $othtml .= "\n";
    $othtml .= '<p>Ci sunnu dui modi dispunìbbili:  "<a href="/cgi-bin/aiutami.pl?lastauto=auto">modu automaticu</a>" e "modu navigatu."'."\n";  
